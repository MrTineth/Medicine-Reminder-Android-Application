...
//    database object:
    ...
    public FloatingActionButton add_user_fab, location,Sensors;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Sensors = findViewById(R.id.sensor);
        ...
        // Set click listener for the "Sensors" button
        Sensors.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Open the SensorsDashBoard activity
                Intent intent = new Intent(MainActivity.this,SensorsDashBoard.class);
                startActivity(intent);
            }
        });
